...
class HelpDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        workflow_text = QLabel(
            ...
            "<h4 style='margin-top: 15px; margin-bottom: 6px;'>Step 1: Load Image</h4>"
            "<ul style='margin-top: 0px;'>"
            ...
            "<h4 style='margin-top: 15px; margin-bottom: 6px;'>Step 2: Set Parameters</h4>"
            "<ul style='margin-top: 0px;'>"
            ...
            "<h4 style='margin-top: 15px; margin-bottom: 6px;'>Step 3: Region Selection</h4>"
            "<ul style='margin-top: 0px;'>"
            "<li>Select 3 points on the image:"
            "<ol>"
            ...
            "<h4 style='margin-top: 15px; margin-bottom: 6px;'>Step 4: Processing</h4>"
            "<ul style='margin-top: 0px;'>"
            ...
            "<h4 style='margin-top: 15px; margin-bottom: 6px;'>Step 5: Results</h4>"
            "<ul style='margin-top: 0px;'>"
